...
void parse_modifier(modifierfactory_t &attribute_fact,
...
void get_modifier_configs(modifierfactory_t &attribute_fact,
                          const std::string &config_file) {
  static constexpr int NUM_MODIFIERS = 17;
  std::array<std::string, NUM_MODIFIERS> modifier_names = {
      {"flat_damage", "enhanced_damage", "enhanced_speed", "flat_range",
       "flat_crit_chance", "flat_crit_multiplier", "flat_type_damage_chaos",
