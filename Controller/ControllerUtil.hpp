...
struct InputEvent {
  explicit InputEvent() : event_type(INPUT_TYPE::NONE), x_pos(-1), y_pos(-1) {}
...
typedef boost::lockfree::spsc_queue<InputEvent, boost::lockfree::capacity<1024>>
    ControllerBufferType;
