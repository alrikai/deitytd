...
std::ostream &operator<<(std::ostream &out_stream,
  ...
  for (int eidx = 0; eidx < tower_properties::NUM_ELEM; eidx++) {
    out_stream << element_names[eidx] << " Damage: [" << props.modifier.damage_value[eidx].low
               << ", " << props.modifier.damage_value[eidx].high << "] \n"
               << element_names[eidx] << "\%-Enhanced Damage: [" << props.modifier.enhanced_damage_value[eidx] << "] \n"
               << element_names[eidx] << "\%-Element affinity: [" << props.modifier.enhanced_damage_affinity[eidx] << "] \n"
               << element_names[eidx] << "Added Damage: [" << props.modifier.added_damage_value[eidx] << "] \n";
  }
  ...
  out_stream << "# On Attack Effects: " << props.modifier.on_attack_events.size() << "\n";
