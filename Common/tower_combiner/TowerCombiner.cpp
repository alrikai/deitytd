...
const std::unordered_map<char, uint32_t>
    TowerCombiner::character_attribute_map = {
        ...
        {'T', flat_damage::ID + 0},
        {'U', flat_damage::ID + 0},
        {'E', enhanced_damage::ID + 0},
        {'D', enhanced_damage::ID + 0},
        {'Q', enhanced_damage::ID + 0},
        {'S', enhanced_speed::ID + 0},
        {'K', enhanced_speed::ID + 0},
        {'R', flat_range::ID + 0},
        {'L', flat_range::ID + 0},
        {'C', flat_crit_chance::ID + 0},
        {'Z', flat_crit_chance::ID + 0},
        {'B', flat_crit_multiplier::ID + 0},
        {'M', flat_crit_multiplier::ID + 0},
