...
struct tower_attribute_modifier {
  ...
  // tower_property object will be passed in, and the attribute modifier will add
  // itself to the appropriate tower modifier lists, etc. as needed
  inline virtual void apply_modifier(tower_properties &) = 0; 
  inline virtual void
  aggregate_modifier(tower_property_modifier &) = 0;
...
struct stat_attribute_modifier : tower_attribute_modifier {
  ...
  inline virtual void apply_modifier(tower_properties &stats) override {(void)stats;}
  inline virtual void
  aggregate_modifier(tower_property_modifier &stats_modifier) override {(void)stats_modifier;}
...
struct event_attribute_modifier : tower_attribute_modifier {
  ...
  virtual void apply_on_event(Monster *mob, Tower *tower, float time_delta) {(void)mob; (void)tower; (void)time_delta;}
};
