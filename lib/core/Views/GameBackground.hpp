...
public:
  ...
  Ogre::AxisAlignedBox get_map_aab() const { return map_aab; }
...
private:
  ...
  // we want to have a dynamic texture for the background that we update as we
  // compute new fflames
  int bg_width;
  int bg_height;
...
// should refactor these -- have one just look for movables, have another that
// looks for the gamemap and the ray distance
